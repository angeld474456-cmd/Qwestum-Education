...
- Remaining polish backlog: public language currently displays the stored code `ru` rather than a user-facing label. Next: planning-only **P1 Public Quest Metadata Presentation Polish**; do not expand into student identity, attempts, payments, assignments, organizations, AI, exports, or broader localization without separate approval.
